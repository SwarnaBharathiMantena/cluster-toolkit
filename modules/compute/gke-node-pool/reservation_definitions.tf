...
locals {
  ...
  specific_reservation_requirement_violations = local.has_gpu ? (length(local.reservation_vm_properties) == 0 ? [] : [for k, v in local.nodepool_vm_properties : k if v != local.reservation_vm_properties[0][k]]) : []
