## Description
The tags module comprises of three resources; [google_tags_tag_key](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/tags_tag_key), [google_tags_tag_value](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/tags_tag_value), and [google_tags_location_tag_binding](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_tags_location_tag_binding).
...
```yaml
  - id: gke-h4d-fw-tags
    ...
    settings:
      ...
      tag_binding:
        - parent: "//compute.googleapis.com/projects/my-gcp-project/zones/us-central1-a/instances/${google_compute_instance.instance.instance_id}" # Compute instance
          location: "us-central1-a" # Location of the target resource
        - parent: "//container.googleapis.com/projects/${var.project_id}/locations/${var.location}/clusters/${var.cluster_name}/nodePools/${var.nodepool_name}" # GKE nodepool
          location: "us-central1-a" # Location of the target resource
```
...
| Name | Type |
|------|------|
| [google_tags_location_tag_binding.bindings](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/tags_location_tag_binding) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_tag_binding"></a> [tag\_binding](#input\_tag\_binding) | A LocationTagBinding represents a connection between a TagValue and a non-global target such as <br/>a Cloud Run Service or Compute Instance. Once a LocationTagBinding is created, <br/>the TagValue is applied to all the descendants of the cloud resource.<br/>parent: The full resource name of the resource the TagValue is bound to. E.g. //cloudresourcemanager.googleapis.com/projects/123<br/>location: Location of the target resource.<br/>Input is a list, ensuring multiple parents with corresponding location can be specified. | <pre>list(object({<br/>    parent   = string<br/>    location = string<br/>  }))</pre> | `[]` | no |
